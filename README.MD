...
```bash
source ./devel/setup.bash
roslaunch orbbec_camera gemini_336.launch
```
...
- `enable_decimation_filter`: Only the G330 series is supported. This filter effectively reduces the depth scene
  complexity. The filter runs on kernel
...
|-----------------|--------------------|
| gemini 336      | gemini 336.launch  |
| gemini 33L      | gemini 336L.launch |
...
- [Gemini 330 depth post procession blocks](https://www.orbbec.com/docs/g330-use-depth-post-processing-blocks/)
